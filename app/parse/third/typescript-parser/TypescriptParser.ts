...
export class TypescriptParser {
  ...
  private parseTypescript(
    ...
    this.parse(file, syntaxList, visit);
        ...
        (node: any) => {
          switch (node.kind) {
            ...
            case SyntaxKind.ImportEqualsDeclaration:
              parseImport(
                moduleResource,
                <ImportDeclaration | ImportEqualsDeclaration>node
              );
              break;
            ...
            case SyntaxKind.ExportAssignment:
              parseExport(
                moduleResource,
                <ExportAssignment | ExportDeclaration>node
              );
              break;
